...
public class RequestInvoiceProcessor implements SagaCommandProcessor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        var response = restTemplate.exchange(
                "http://localhost:8082/api/v1/inventory/invoice",
                HttpMethod.PUT,
        ...
        order.setInvoiceId(response.getBody().getInvoiceId());
